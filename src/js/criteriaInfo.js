const CriteriaInfo = {
    ...
    health_care_index: "No info",
    pollution_index: "No info",
    property_price_to_income_ratio: "No info",
    ...
    safety_index: "No info",
    traffic_co2_index: "No info",
    traffic_index: "No info",
    traffic_inefficiency_index: "No info",
    traffic_time_index: "No info",
};
